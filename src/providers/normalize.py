from src.pipeline.geo_registry import ORIGIN_METRO, DEST_REGION, DEST_COUNTRY

def normalize_offer(source, it):
    # Adjust fields to your provider's shape
    route = it.get("route", [])
    first = route[0] if route else {}
    departure = first.get("local_departure","0000-00-00T00:00:00")  # ISO
